Aria.classDefinition({
  $classpath: "examples.controller.MyModuleController",
  $extends: "aria.templates.ModuleCtrl",
  $implements: ["examples.controller.IMyModuleController"],
  ...
  $prototype: {
    ...
    $publicInterfaceName: "examples.controller.IMyModuleController",
    /**
