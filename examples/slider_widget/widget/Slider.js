...
Aria.classDefinition({
  $classpath : 'examples.slider_widget.widget.Slider',
  ...
  $css : ['examples.slider_widget.widget.SliderCSS'],
  ...
  $dependencies : ['examples.slider_widget.widget.SliderCfgBeans', 'aria.utils.Event', 'aria.DomEvent'],
  ...
  $constructor : function (cfg, context, lineNumber) {
    ...
    var normalizeArg = {
      beanName : "examples.slider_widget.widget.SliderCfgBeans.SliderCfg",
      json : this._cfg
    };
    try {
      /**
